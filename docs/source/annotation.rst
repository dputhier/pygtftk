...
.. command-output:: gtftk ologram -i tiny_real.gtf.gz -p ENCFF112BHN_H3K4me3_K562_tiny.bed -c hg38.genome -u 1500 -d 1500 -D  -if example_pa_01.pdf -k 4
	:shell:
...
.. command-output:: gtftk ologram -i tiny_real.gtf.gz -m gene_biotype -p ENCFF112BHN_H3K4me3_K562_tiny.bed -c hg38.genome -D -n  -if example_pa_02.pdf
	:shell:
...
.. command-output:: gtftk join_attr -i tiny_real.gtf.gz -H -j mini_real_counts_ENCFF630HEX.tsv -k gene_name -n exprs -t gene | gtftk discretize_key -k exprs -p -d exprs_class -n 6   | gtftk ologram -p ENCFF112BHN_H3K4me3_K562_tiny.bed -c hg38.genome -D -n -m exprs_class -if example_pa_03.pdf
	:shell:
...
.. command-output:: gtftk add_exon_nb -k exon_nbr -i tiny_real.gtf.gz | gtftk discretize_key -p -d exon_nbr_cat -n 5  -k exon_nbr | gtftk ologram -p ENCFF112BHN_H3K4me3_K562_tiny.bed -c hg38.genome -D -n -m exon_nbr_cat -if example_pa_04.pdf
	:shell:
