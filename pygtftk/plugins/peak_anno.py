...
__notes__ = """
 ...
 -- The list of region and inter-region lengths can be independantly shuffled or using a Markov model of order 2 (only use if you suspect there is a structure to the data, not recommended in the general case).
...
def peak_anno(inputfile=None,
    ...
    # We work with a pybedtools object.
